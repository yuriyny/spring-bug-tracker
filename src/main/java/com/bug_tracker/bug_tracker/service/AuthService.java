...
import com.bug_tracker.bug_tracker.model.VerificationToken;
...
public class AuthService {
    ...
    public List<UserDto> getAllUserNotInTheList(List<String> users) {

        return this.userRepository.findByUsernameNotIn(users)
                .stream()
                .map(user -> userMapper.mapUserToDto(user))
                .collect(toList());
    }
